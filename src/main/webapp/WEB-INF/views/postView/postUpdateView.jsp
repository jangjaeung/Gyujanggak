...
<body>
	...
	<input type="hidden" name="postNo" value="${post.postNo }">
		<table>
			<tr>
				<td width='80'>제목</td>
				<td><input type="text" size="50" name="postTitle" id="title" value="${post.postTitle }"></td>
			</tr>
			<tr>
				<td>작성자</td>
			...
			<tr>
				<td>내용</td>
				<td><textarea rows='17' name="postContents" id="cont">${post.postContents }</textarea></td>
			</tr>
		</table>
		<div>
			<input type="submit" id="sb" value="수정완료">
		</div>
	</form>
	</div>
