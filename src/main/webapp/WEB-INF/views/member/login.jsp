      ...
      <div class="content">
        ...
        <form action="login.do" method="post">
          <div class="field">
            ...
            <input type="text" required placeholder="ID" name="user-id" id="user-id">
          </div>
          <div class="field space">
            <span class="fa fa-lock"></span>
            <input type="password" class="pass-key" required placeholder="Password" name="user-pwd" id="user-pwd">
