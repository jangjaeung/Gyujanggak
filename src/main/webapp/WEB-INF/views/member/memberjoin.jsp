	...
	<div class="bg-img">
		<div class="content" style="width: 40%; height: 83%;">
          ...
          <input type='file' id="imgInput" style="position: absolute;bottom: 46%;right: -2%;" name="uploadFile"/>
			...
			<input type="hidden" value="${kakaoId }" name="socialId">
			</c:if>
          ...
          <input type="hidden" name="userType" value="일반">
          ...
          <div class="field space">
            <input type="text" class="pass-key" required placeholder="핸드폰 번호" name="userPhone" id="userPhone">
          </div>
