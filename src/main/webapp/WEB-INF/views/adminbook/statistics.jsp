...
// 	};
	...
	$('.lending-count11').each(function(i){
		...
		var data1 = Math.ceil(arrSlice1/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data2 = Math.ceil(arrSlice2/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data3 = Math.ceil(arrSlice3/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data4 = Math.ceil(arrSlice4/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data5 = Math.ceil(arrSlice5/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data6 = Math.ceil(arrSlice6/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data7 = Math.ceil(arrSlice7/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data8 = Math.ceil(arrSlice8/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data9 = Math.ceil(arrSlice9/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
		var data10 = Math.ceil(arrSlice10/(arrSlice1+arrSlice2+arrSlice3+arrSlice4+arrSlice5+
				arrSlice6+arrSlice7+arrSlice8+arrSlice9+arrSlice10)*100);
	...
	var myChart = new Chart(ctx, {
	   ...
	   labels: ["총류", "철학", "종교", "사회과학", "자연과학", "기술과학", "예술", "언어", "문학", "역사"],
	        datasets: [{
	            label: 'Percentage',
	            data: [data10, data9, data8, data3,data7,data1, data6, data4, data2, data5],
	            backgroundColor: [
	                'rgba(255, 99, 132, 0.2)',
	                'rgba(54, 162, 235, 0.2)',
	                'rgba(255, 206, 86, 0.2)',
