...
<jsp:include page="../common/header.jsp"></jsp:include>
	...
	<form action="booksEnroll.do" method="post" enctype="multipart/form-data">
        ...
        <div class="image-container">
            <img style="width: 15%;left: 54%;top: 20%; height: 30%;" id="preview-image" src="https://media.istockphoto.com/vectors/photo-album-icon-vector-id1023892724?k=20&m=1023892724&s=170667a&w=0&h=zXZB3iWNnwhrDA055eJgxh4Sq814_ZNRSVAJT7lBgLY=">
            <input style="display: block; left: 54%;bottom: 46%;" type="file" id="input-image" name="bookCoverFile">
            </div>
  
		<div style="text-align:center; margin-top: 5%;" >
			<input type="submit" value="등록">
			<a href="bookListView.do">취소</a>
		</div>
	</form>
